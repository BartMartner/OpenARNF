...
public class Ballistics
{
    ...
    // c0 = -1/2 Gravity
    // c1 = Initial Velocity
    // c2 = Initial Height - Target Height
    ...
    /// <param name="gravity">force of gravity, positive is down</param>
    /// <param name="initial_height">distance above flat terrain</param>
    ...
    /// </summary>
    /// <param name="proj_pos">point projectile will fire from</param>
    /// <param name="proj_speed">scalar speed of projectile</param>
    /// <param name="target">point projectile is trying to hit</param>
    /// <param name="gravity">force of gravity, positive down</param>
    /// <param name="s0">firing solution (low angle) </param>
    /// <param name="s1">firing solution (high angle)</param>
    /// <returns>number of unique solutions found: 0, 1, or 2.</returns>
    ...
    /// <param name="proj_pos">point projectile will fire from</param>
    /// <param name="proj_speed">scalar speed of projectile</param>
    /// <param name="target_pos">point projectile is trying to hit</param>
    /// <param name="target_velocity">velocity of target</param>
    /// <param name="gravity">force of gravity, positive down</param>
    /// <param name="s0">firing solution (fastest time impact)</param>
    /// <param name="s1">firing solution (next impact)</param>
    /// <returns>number of unique solutions found: 0, 1, 2, 3, or 4.</returns>
    ...
    /// </summary>
    /// <param name="proj_pos">point projectile will fire from</param>
    /// <param name="lateral_speed">scalar speed of projectile along XZ plane</param>
    /// <param name="target_pos">point projectile is trying to hit</param>
    /// <param name="max_height">height above Max(proj_pos, impact_pos) for projectile to peak at</param>
    /// <param name="fire_velocity">firing velocity</param>
    /// <param name="gravity">gravity necessary to projectile to hit precisely max_height</param>
    ...
    /// <param name="target"> point projectile is trying to hit</param>
    /// <param name="target_velocity">velocity of target</param>
    /// <param name="max_height_offset">height above Max(proj_pos, impact_pos) for projectile to peak at</param>
    /// <param name="fire_velocity">firing velocity</param>
    /// <param name="gravity">gravity necessary to projectile to hit precisely max_height</param>
    /// <param name="impact_point">point where moving target will be hit</param>
    /// <returns>true if a valid solution was found</returns>
